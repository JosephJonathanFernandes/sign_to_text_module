...
# Model Inference Latency & Profiling Report
...
> [!TIP]
> **Performance Target Exceeded:** The optimized FP32 ONNX model operates at ~2.28 ms per frame, completely crushing the 33 ms budget required for 30 FPS real-time signing recognition!

### Core Performance Breakdown (ONNX FP32)

* **Average Live Frame Processing Time:** 2.28 ms
* **Sustained System Execution Throughput:** 438.5 FPS

---

### Hardware Benchmarking Comparison

| Model Architecture               | Avg Latency (ms) | Throughput (FPS) |
|----------------------------------|-----------------:|-----------------:|
| 1. PyTorch Baseline (.pth)       |         11.31 ms |         88.4 FPS |
| 2. **ONNX FP32 (.onnx)**         |      **2.28 ms** |    **438.5 FPS** |
| 3. ONNX INT8 Quantized           |          3.76 ms |        265.6 FPS |
