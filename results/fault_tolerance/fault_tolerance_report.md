...
| NaN Value Injection | ✅ PASS | Handled NaN safely: received 1008 (policy violation) Policy Violation: Invalid Data; then sent 1008 (policy violation) Policy Violation: Invalid Data |
